...
deploy-loopStrategyWstETHoverETH-5x-base-mainnet 		:; forge script script/deploy/base-mainnet/DeployLoopStrategyWstETHoverETH_5x.s.sol --tc DeployLoopStrategyWstETHoverETH_5x --force --rpc-url base --chain base --slow --broadcast --verify --delay 5 -vvvv
deploy-loopStrategyWstETHoverETH-5x-tenderly 				:; forge script script/deploy/base-mainnet/DeployLoopStrategyWstETHoverETH_5x.s.sol --tc DeployLoopStrategyWstETHoverETH_5x --force --rpc-url tenderly --slow --broadcast -vvvv --verify --verifier-url ${TENDERLY_FORK_VERIFIER_URL} --etherscan-api-key ${TENDERLY_ACCESS_KEY}

deploy-loopStrategyWstETHoverETH-10x-base-mainnet 		:; forge script script/deploy/base-mainnet/DeployLoopStrategyWstETHoverETH_10x.s.sol --tc DeployLoopStrategyWstETHoverETH_10x --force --rpc-url base --chain base --slow --broadcast --verify --delay 5 -vvvv
deploy-loopStrategyWstETHoverETH-10x-tenderly 				:; forge script script/deploy/base-mainnet/DeployLoopStrategyWstETHoverETH_10x.s.sol --tc DeployLoopStrategyWstETHoverETH_10x --force --rpc-url tenderly --slow --broadcast -vvvv --verify --verifier-url ${TENDERLY_FORK_VERIFIER_URL} --etherscan-api-key ${TENDERLY_ACCESS_KEY}
