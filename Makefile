...
clean                   :; forge clean
fmt                     :; forge fmt
run-simulation          :; mkdir ./test/integration/output && forge test -vvv --mt test_e2eSimulation
test                    :; forge test -vvv --no-match-test test_e2eSimulation --gas-report && make run-simulation
