...
deploy-loopStrategyWstETHoverETH-4p5x-base-mainnet 		:; forge script script/deploy/base-mainnet/DeployLoopStrategyWstETHoverETH_4p5x.s.sol --tc DeployLoopStrategyWstETHoverETH_4p5x --force --rpc-url base --chain base --slow --broadcast --verify --delay 5 -vvvv
deploy-loopStrategyWstETHoverETH-4p5x-tenderly 				:; forge script script/deploy/base-mainnet/DeployLoopStrategyWstETHoverETH_4p5x.s.sol --tc DeployLoopStrategyWstETHoverETH_4p5x --force --rpc-url tenderly --slow --broadcast -vvvv --verify --verifier-url ${TENDERLY_FORK_VERIFIER_URL} --etherscan-api-key ${TENDERLY_ACCESS_KEY}
...
deploy-loopStrategyETHoverUSDC-4p5x-base-mainnet 			:; forge script script/deploy/base-mainnet/DeployLoopStrategyETHoverUSDC_4p5x.s.sol --tc DeployLoopStrategyETHoverUSDC_4p5x --force --rpc-url base --chain base --slow --broadcast --verify --delay 5 -vvvv
deploy-loopStrategyETHoverUSDC-4p5x-tenderly 					:; forge script script/deploy/base-mainnet/DeployLoopStrategyETHoverUSDC_4p5x.s.sol --tc DeployLoopStrategyETHoverUSDC_4p5x --force --rpc-url tenderly --slow --broadcast -vvvv --verify --verifier-url ${TENDERLY_FORK_VERIFIER_URL} --etherscan-api-key ${TENDERLY_ACCESS_KEY}
